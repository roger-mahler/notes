...
+ [eBook: Problem Solving with Python](https://problemsolvingwithpython.com/)
+ [eBook: Problem Solving with Algorithms and Data Structures using Python](http://interactivepython.org/courselib/static/pythonds/index.html)
+ [google/styleguide](https://github.com/google/styleguide/blob/gh-pages/pyguide.md)
+ [Full Stack Python](https://www.fullstackpython.com/)
+ [Unicode HOWTO](https://docs.python.org/3/howto/unicode.html#the-unicode-type)
+ [The Python Graph Gallery](https://python-graph-gallery.com/)

## Packages to look into
---------------------------

+ [vbmfa](https://pypi.org/project/vbmfa/)
...
+ [joblib](https://joblib.readthedocs.io/en/latest/parallel.html) [Github](https://github.com/joblib/joblib)
+ [seaborn](http://seaborn.pydata.org/)
+ [hvplot](https://hvplot.pyviz.org/getting_started/index.html)
+ [plotly](https://plot.ly/python/getting-started/) [3d](https://plot.ly/python/3d-network-graph/)
+ [worldgraphs/geograph](https://rdrr.io/github/thibautjombart/geograph/man/worldgraphs.html)
+ [scrapinghub/portia](https://github.com/scrapinghub/portia) [webstruct](https://github.com/scrapinghub/webstruct)
...
+ [iitmcvg/numpy\_exercises: Numpy exercises. Thanks @Kyubyong! This would be an amazing set of exercises for our freshers to learn from!](https://github.com/iitmcvg/numpy_exercises)
